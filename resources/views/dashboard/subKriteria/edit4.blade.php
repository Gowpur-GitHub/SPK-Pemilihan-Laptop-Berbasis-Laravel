                ...
                <form action="{{ route('data-sub-kriteria4.update', $subkriteria->slug) }}" method="POST"
                    ...
                    <div class="mb-3 row">
                        <label for="VGA"
                            ...
                            Kriteria</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control @error('VGA')
                                  is-invalid
                              @enderror" id="VGA" value="{{ old('VGA', $subkriteria->VGA) }}"
                                name="VGA" required>
                            @error('VGA')
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="number" class="form-control @error('nVGA')
                                  is-invalid
                              @enderror" id="nVGA"
                                value="{{ old('nVGA', $subkriteria->nVGA) }}" name="nVGA"
                                required>
                            @error('nVGA')
                            <div class="invalid-feedback">
                                {{ $message }}
...
<script>
    const VGA = document.querySelector("#VGA");
        ...
        VGA.addEventListener("keyup", () => {
            // let preslug = VGA.value;
