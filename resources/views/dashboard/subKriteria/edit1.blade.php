                ...
                <form action="{{ route('data-sub-kriteria1.update', $subkriteria->slug) }}" method="POST"
                    ...
                    <div class="mb-3 row">
                        <label for="RAM"
                            ...
                            Kriteria</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control @error('RAM')
                                  is-invalid
                              @enderror" id="RAM" value="{{ old('RAM', $subkriteria->RAM) }}"
                                name="RAM" required>
                            @error('RAM')
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="number" class="form-control @error('nRAM')
                                  is-invalid
                              @enderror" id="nRAM"
                                value="{{ old('nRAM', $subkriteria->nRAM) }}" name="nRAM"
                                required>
                            @error('nRAM')
                            <div class="invalid-feedback">
                                {{ $message }}
...
<script>
    const RAM = document.querySelector("#RAM");
        ...
        RAM.addEventListener("keyup", () => {
            // let preslug = RAM.value;
